// Prometheus exporter that pings Minecraft servers via Server List Ping
package main
...
// Subset of the status response the exporter reports
...
// Performs a minimal Server List Ping, handshake then status request
