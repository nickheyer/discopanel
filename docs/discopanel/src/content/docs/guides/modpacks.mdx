...
You can also point an existing server at a pack from its configuration tab:
...
- If you didn't, turn on **Force Re-Provision** in the server configuration and restart. The newest version gets installed and the switch turns itself back off.
