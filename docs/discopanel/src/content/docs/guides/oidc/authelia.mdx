...
<Aside>
Authelia is typically deployed behind a reverse proxy like Traefik. The included configuration uses self-signed TLS certificates and the `traefik.me` wildcard domain for development. See the [Authelia docs](https://www.authelia.com/integration/proxies/) for production proxy integration.
</Aside>
