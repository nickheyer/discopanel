...
**Use MeowIce Flags** is a newer, more aggressive set for modern Java versions. Enabling it takes the place of the default Aikar set. Pick one of the two, not both.
