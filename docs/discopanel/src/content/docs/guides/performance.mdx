...
If you ever need to, untick **Enable DiscoPanel Agent** in the configuration tab. Everything keeps working, DiscoPanel just falls back to slower measuring (server pings), and boot-time console commands and live tick timing go away.
