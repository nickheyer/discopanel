...
DiscoPanel picks the recommended build for your Minecraft version, or the latest stable one if there's no recommendation. If you need a specific Forge or NeoForge build, set the **Forge Version** field in the server configuration.
