...
type ServerConfig struct {
	...
	// JVM / Runtime (passed to the discopanel-runtime container as environment variables)
	...
	// server.properties (written by the provisioner before each start)
	...
	// Auto-Pause (panel-side; requires the server to be behind the DiscoPanel proxy)
